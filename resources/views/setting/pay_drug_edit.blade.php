        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">แก้ไขเบิก-จ่ายยา</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">แก้ไขเบิก-จ่ายยา
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">                   
                        <a href="{{ url('setting/pay_drug/'.(Auth::user()->store_id).'/'.(Auth::user()->id) )}}" class="float-sm-right btn btn-info btn-glow round px-2"><i class="fas fa-hand-point-left text-white-90 mr-1" style="font-size:15px "></i>ย้อนกลับ</a>                                                                 
                    </div>
                </div>
            </div>
                                        ...
                                        <form action="{{ route('setting.pay_drug_update')}}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-2 mb-2 text-left">
                                                        ...
                                                        <select name="PAY_YEAR" id="PAY_YEAR" class="form-control" style=" font-family: 'Kanit', sans-serif;" required>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-5 mb-3 text-left">
                                                            ...
                                                            <select name="PAY_STORE" id="PAY_STORE" class="form-control" style=" font-family: 'Kanit', sans-serif;" required>
                                                                <option value="">--เลือก--</option>
                                                        ...
                                                        <div class="col-md-3 mb-3 text-left">
                                                            ...
                                                            <select name="PAY_USER" id="PAY_USER" class="form-control" style=" font-family: 'Kanit', sans-serif;" required>
                                                                <option value="">--เลือก--</option>
                                                        ...
                                                        <div class="col-md-4 mb-3 text-left">
                                                            <label for="PAY_APPROVER">ผู้เห็นชอบ :</label>
                                                                <select name="PAY_APPROVER" id="PAY_APPROVER" class="form-control" style=" font-family: 'Kanit', sans-serif;" required>
                                                                    <option value="">--เลือก--</option>
                                                                ...
                                                                <tbody class="tbody1">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input list="store_pay" name="PAYDETAIL_DRUG_ID[]" id="PAYDETAIL_DRUG_ID[]" class="form-control" value="{{$pay_detail->PAYDETAIL_DRUG_ID}} => {{ $pay_detail-> PAYDETAIL_DRUG_CODE}} => {{ $pay_detail-> PAYDETAIL_DRUG_NAME}}">
                                                                        ...
                                                                        <td>
                                                                            <input name="PAYDETAIL_DRUG_PRICE[]" id="PAYDETAIL_DRUG_PRICE[]" class="form-control" value="{{ $pay_detail ->PAYDETAIL_DRUG_PRICE }}">
                                                                        </td>
...
$('.addRow').on('click',function(){
     ...
     function addRow(){
        ...
        var tr ='<tr>'+
                ...
                '</td>'+
                '<td>'+
                '<input name="PAYDETAIL_DRUG_PRICE[]" id="PAYDETAIL_DRUG_PRICE[]" class="form-control">'+
                '</td>'+
                '<td style="text-align: center;"><a class="btn btn-sm btn-danger fa fa-trash-alt remove" style="color:#FFFFFF;"></a></td>'+
                '</tr>';
        $('.tbody1').append(tr);
