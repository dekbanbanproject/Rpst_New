        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">รายการรับยาเข้าระบบ</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">รายการรับยาเข้าระบบ
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right"> 
                        <a href="{{url('setting/recieve_drug_add/'.(Auth::user()->store_id).'/'.(Auth::user()->id))}}" class="float-sm-right btn btn-success btn-glow round px-2"><i class="fas fa-cart-plus text-white-90 mr-1" style="font-size:15px "></i>รับยาเข้าระบบ&nbsp; </a>
                                                        ...
                                                        <?php $number++;  ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    ...
                                                                    <a class="btn btn-warning btn-glow round px-2" href="{{ url('setting/recieve_drug_edit/'.(Auth::user()->store_id).'/'.(Auth::user()->id).'/'.$rec->REC_ID )  }}" ><i class="fas fa-fw fa-edit" style='font-size:15px;color:white'></i>  </a>
                                                                    @endif
                                                                    @if((Auth::user()->user_delete) == 'on' ) 
                                                                    <a class="btn btn-danger btn-glow round px-2" href="{{ url('setting/recieve_drug_destroy/'.(Auth::user()->store_id).'/'.(Auth::user()->id).'/'.$rec->REC_ID)}}" onclick="return confirm('ต้องการที่จะลบข้อมูล ?')" ><i class="fas fa-fw fa-trash font-small-5" style='font-size:15px;color:white'></i></a>
